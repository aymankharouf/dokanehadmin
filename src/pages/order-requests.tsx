...
const OrderRequests = () => {
  ...
  useEffect(() => {
    setOrderRequests(() => {
      let requests = state.orders.filter((r: any) => r.requestType)
      requests = requests.map((r: any) => {
        const customerInfo = state.customers.find((c: any) => c.id === r.userId)
      ...
      return requests.sort((r1: any, r2: any) => r2.requestTime.seconds - r1.requestTime.seconds)
    })
