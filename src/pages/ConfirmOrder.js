  ...
  return(
    ...
    <Block>
        <List>
          ...
          <ListItem title="Total" className="total" after={totalPrice}></ListItem>
          <ListItem title="Delivery" className="delivery" after="0.250"></ListItem>
          <ListItem title="Net Total" className="net" after={totalPrice + 0.250}></ListItem>
          <ListInput
            label="Note"
            type="textarea"
            inputId="note"
